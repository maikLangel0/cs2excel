...
All you should need to do is pull and do cargo run --release. You might have to allow a bigger stack allocation during the build process as Slint uses A LOT to create the neccessary macros.
