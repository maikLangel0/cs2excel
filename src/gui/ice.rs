...
pub struct App {
    ...
    pick_list_usd_to_x: Vec<Currencies>,
...
impl Default for App {
    fn default() -> Self {
        App {
            ...
            pick_list_usd_to_x: {
                let mut curr = Currencies::iter().filter(|c| *c != Currencies::None).collect::<Vec<Currencies>>();
                curr.sort_by(|a, b| a.as_str().cmp(b.as_str()));
                curr.push( Currencies::None );
                curr
            },
